...
<input type="image" src="png/start.png" width="100" height="100" class="btn btn-outline-success btn-lg" onclick="location='includevc/server.php'; Confirm(this.form); " />
&nbsp;&nbsp;&nbsp;&nbsp;
<input type="image" src="png/off.png" width="100" height="100" class="btn btn-outline-danger btn-lg" onclick="location='includevc/serveroff.php'; Confirm(this.forms); " />
&nbsp;&nbsp;&nbsp;&nbsp;
