<link rel="icon" href="webnet.png" type="image/x-icon" />
<?php
echo "<html><link rel='icon' href='webnet.png' type='image/x-icon' />
...
echo "<center><h1><font color='cyan'>WebNet Official-Hosting</font><br><img src='cp.png' width='50' height='30'></h1>";
echo " <img src='vps.png' width='300' height='200'></center> ";
/**
 * File Manager Script
 */
...
// Users: array('Username' => 'Password', 'Username2' => 'Password2', ...), Password has to encripted into MD5.. use https://www.md5hashgenerator.com/ to generate password
$auth_users = array(
...
$root_url = 'GSB/filemanager'; // change this to specific folder u made or leave it as it is
    ...
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        <div class="path login-form">
            <form action="" method="post">
			 <img src="webnet.png" alt="cpanel" width="60" height="60"> 
			 
			<!--<h1><i>Control Panel</i></h1>--><br>
                ...
                <input type="submit" class="btn btn-primary btn-lg" value="<?php echo fm_t('Login', $lang) ?>">
            </form>
        </div>
		<style>
		body {
