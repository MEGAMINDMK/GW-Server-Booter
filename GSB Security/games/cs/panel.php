...
<title>CS 1.6-SERVER-BOOTER</title>
<link rel="icon" href="png/CS_logo.png" type="image/x-icon" />
<body style="background-color:black;">
<center>
<h1><font color="white">Welcome to CS 1.6 Server-Boot Manager</font></h1>
 <img src="png/CS_logo.png" width="600" height="300"> 
...
<input type="image" src="png/start.png" width="100" height="100" class="btn btn-outline-success btn-lg" onclick="location='includecs/server.php'; Confirm(this.form); " />
&nbsp;&nbsp;&nbsp;&nbsp;
<input type="image" src="png/off.png" width="100" height="100" class="btn btn-outline-danger btn-lg" onclick="location='includecs/serveroff.php'; Confirm(this.forms); " />
&nbsp;&nbsp;&nbsp;&nbsp;
<input type="image" src="png/restart.png" width="100" height="100" class="btn btn-outline-primary btn-lg" onclick="location='includecs/restart.php'; Confirm(this.form); " />
&nbsp;&nbsp;&nbsp;&nbsp;
